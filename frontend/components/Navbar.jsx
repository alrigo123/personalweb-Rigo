    ...
    return (
        <div
            ...
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
                <Link href='/'>
                    <Image src="/../public/assets/logaso.png" alt='/' width='125' height='50' />
                </Link>
                <div>
                    <ul style={{ color: `${linkColor}` }} className='hidden md:flex'>
                        ...
                        <Link href="/#rewards">
                            <li className='ml-10 text-sm uppercase hover:border-b'>Logros</li>
                        </Link>
                ...
                <div className={nav ?
                    ...
                    <div>
                        <div className='flex w-full items-center justify-between'>
                            ...
                            <Image src='/../public/assets/logaso2.png' width='87' height='35' alt='/' />
                    ...
                    <div className='py-4 flex flex-col'>
                        <ul className='uppercase'>
                            ...
                            <Link href='/#rewards'>
                                <li onClick={() => setNav(false)} className='py-4 text-sm'>Logros</li>
                            </Link>
                            <Link href='/#publications'>
